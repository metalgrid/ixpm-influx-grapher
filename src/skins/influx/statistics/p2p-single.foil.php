        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 mt-4">
            <div class="card">
                ...
                <div class="card-body">
                    <p>
                        <?php
                        $t->graph->setDestinationVlanInterface($dstVli, false)->setType('log')->setPeriod($pid);
                        $t->graph->authorise();
                        ?>
                        <canvas class="chart img-responsive" id="<?= $pname . ":" . $dstVli->id ?>" data-url="<?= $t->graph->url() ?>"></canvas>
                    </p>
                </div>
            </div>
        </div>
